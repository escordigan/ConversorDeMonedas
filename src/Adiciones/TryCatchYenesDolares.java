...
public class TryCatchYenesDolares {

    public static void TryCaseFive(){
        ...
        try {
            ...
            String apiUrl = "https://v6.exchangerate-api.com/v6/0eb6ae9584d9c4bd5fb92079/pair/USD/JPY/" + conversionCinco;
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                System.out.println("Conversion del valor de dólares americanos a yenes japoneses: " + conversion_result);
                System.out.println("                                                              ");
                System.out.println("Valor de la tasa de cambio utilizada, en yenes japoneses: " + conversion_rate);
    ...
    public static void TryCaseSix(){
        ...
        try {
            ...
            // URL del API endpoint
            String apiUrl = "https://v6.exchangerate-api.com/v6/0eb6ae9584d9c4bd5fb92079/pair/JPY/USD/" + conversionSeis;
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                // Imprimiendo los Strings extraidos de JSON
                System.out.println("Conversion del valor de yenes japoneses a dólares americanos: " + conversion_result);
                System.out.println("                                                              ");
